    //Lab-5 Question-No 1 Create a function using function declaration named sum with one parameter of Array type, the
            ...
            console.log("The sum is : " + sum([1, 2, 3, 4, 5,10]));
            ...
            console.log(getNewArray(['Anoj Kumar', 'Akshada', 'Prof Tina', 'Prakriti', 'Shanta', 'Tulips']));
            
            // Output: [ 'Anoj Kumar', 'Akshada', 'Prof Tina', 'Prakriti', 'Shanta']
            ...
            const concat = (inputString, numberArray, stringArray) => {
                let returnArr = [...inputString, ...numberArray, ...stringArray];
                return returnArr;
            }
